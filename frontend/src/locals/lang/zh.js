  ...
  lemon: {
    ...
    check: {
      docker: {
        ...
        skipSandboxCheckConfirm: "您确定要跳过沙盒环境检查吗？",
        skip: "跳过",
        continue: "继续",
        ...
        sandboxCheckSucceeded: "沙盒环境检查成功",
