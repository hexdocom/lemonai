  ...
  lemon: {
    ...
    check: {
      docker: {
        sandboxCheck: "沙箱检查",
        sandboxService: "沙箱服务",
        dockerInstallation: "Docker 安装",
        DockerSystem: "检查系统平台",
        dockerStartup: "Docker 启动",
        dockerLaunch: "Docker 启动",
        ...
        option1: "选项 1",
        recommended: "（推荐）",
        lemonOfflineDownload: "Lemon 离线下载",
        option2: "选项 2",
        dockerOfficialWebsite: "Docker 官方网站",
        tryingToStartDocker: "尝试启动 Docker",
        dockerIsStarting: "Docker 正在启动...",
        imageNotDetected: "未检测到镜像 'lemon-runtime-sandbox:latest'。请根据选项获取镜像后，然后点击继续。",
        getLemonRuntimeSandboxImage: "获取 Lemon 运行时沙箱镜像",
        runCommand: "运行命令：",
        toGetSandboxImage: "以获取沙箱镜像",
        dockerIsRunning: "Docker 正在运行 ✅",
        skipSandboxCheckConfirm: "您确定要跳过沙箱环境检查吗？",
        skip: "跳过",
        continue: "继续",
        checkingSystemPlatform: "检查系统平台",
        pleaseWait: "请稍候...",
        checkingDockerInstallation: "检查 Docker 安装",
        checkingDockerStartup: "检查 Docker 启动",
        checkingLemonImage: "检查 Lemon 镜像",
        sandboxCheckSucceeded: "沙箱环境检查成功",
        platformNotSupported: "平台不受支持",
        dockerNotDetected: "未检测到 Docker。请安装 Docker 并点击继续。",
        dockerNotRunning: "Docker 未运行。正在尝试启动 Docker...",
        dockerStartedSuccessfully: "Docker 启动成功",
        dockerImageNotReady: "Docker 镜像未缺失",
        dockerNotInstalled: "Docker 未安装",
        dockerNotRunningStatus: "Docker 未运行",
        sandboxImageNotExist: "未检测到沙箱镜像",
        dockerIsRunningStatus: "Docker 正在运行......",
        // check/index.vue
        sandboxStep: "沙箱环境设置",
        modelStep: "模型平台设置",
        searchStep: "搜索引擎设置",
        next: "下一步",
        complete: "完成",
        configCompleted: "Lemon 配置已完成",
        enableModelPlatformFirst: "请先启用一个模型平台",
        configureSearchEngineFirst: "请先配置搜索引擎",
        configSucceeded: "Lemon 配置成功",
        dockerNotReady: "沙箱环境未就绪",
        dockerNotReadyDes: "Docker环境异常, 点击检查Docker后再试",
      },
      // ... existing code ...
      dockerIsRunningStatus: "Docker 正在运行......",
      // check/index.vue
    ...
    sub: {
      ...
      saasType: "Saas User",
      goToView: "查看更多",
      cloudServiceReady: "云服务，开箱即用",
      cloudSandbox: "Lemon 提供云沙箱服务",
      cloudModel: "Lemon 提供云模型服务",
      cloudSearch: "Lemon 提供云搜索服务",
      supportSelfModel: "支持自定义订阅模型",
      supportModelSeries: "支持 DeepSeek、Qwen3、Gemini、GPT 等系列模型",
      supportSelfSearch: "支持自定义订阅搜索引擎",
      localDockerType: "Local Docker",
      select: "选择",
      requireLocalSandbox: "需本地沙箱环境",
      localDockerConfigType: "Local Config",
      requireModelConfig: "需配置模型",
      requireSearchConfig: "需配置搜索引擎",
      notLoggedIn: "当前未登录，请先登录后重试",
      notSubscribed: "当前账号未订阅，请先订阅",
      enableCloudFailed: "启用 Lemon 云模型和搜索服务失败",
      enableCloudSuccess: "Lemon 云模型和搜索服务已启用"
    },
  },
  //设置界面
  setting: {
    ...
    searchService: {
      ...
      searchEngineTipsThree: "第三步：点击检查APIKey",
      title: "搜索服务",
    ...
    mcpService: {
      ...
      mcpServer: "MCP 服务器",
      noServers: "没有服务器",
      noServerSelected: "未启用服务器",
      newServer: "新建服务器",
      deleteConfirmTitle: "删除服务器",
      deleteConfirmContent: "确定删除该MCP服务器吗?",
      importFromJson: "从 JSON 导入",
      importModalTitle: "从 JSON 导入",
      importModalDescription: "请粘贴单个服务器的 JSON 配置, 示例如下",
      importSuccess: "导入成功",
      importError: {
