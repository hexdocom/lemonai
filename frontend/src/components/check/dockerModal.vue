<template>
    <a-modal v-model:visible="visible" width="auto" centered="true" :footer="null" closable="false" class="docker-checker-modal"
        ...
        <div class="modal-content">
            ...
            <div class="main-content">
                            ...
                            <div class="more">
                                ...
                                <div class="image" v-else-if="showImgTip">
                                    ...
                                    <div class="tip">
                                        ...
                                        <div
                                            style="display:flex;gap: 10px; align-content: start;flex-direction: column;">
                ...
                <div class="action-button">
                    ...
                    <a-button type="primary" :loading="isLoading" @click="handleAction"
                        :disabled="!canContinue && !isComplete">
